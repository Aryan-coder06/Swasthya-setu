...
#     name: str = Field(validation_alias=AliasChoices("name", "drug_name", "medicine_name", "med_name", "brand_name"))
#     dosage: Optional[str] = Field(default=None, validation_alias=AliasChoices("dosage", "dose", "strength", "dose_strength"))
#     frequency: Optional[str] = Field(default=None, validation_alias=AliasChoices("frequency", "freq", "times_per_day", "schedule", "sig"))
#     duration: Optional[str] = Field(default=None, validation_alias=AliasChoices("duration", "days", "course", "for", "no_of_days"))
#     notes: Optional[str] = Field(default=None, validation_alias=AliasChoices("notes", "instructions", "direction", "directions", "admin", "route"))
...
#     vitals: Optional[Dict[str, str]] = Field(default=None, validation_alias=AliasChoices("vitals", "vital_signs"))
#     diseases_diagnoses: List[str] = Field(default_factory=list, validation_alias=AliasChoices("diseases_diagnoses", "diagnosis", "diagnoses", "diseases"))
#     medications: List[Medication] = Field(default_factory=list, validation_alias=AliasChoices("medications", "meds", "medicine_list", "prescribed_medicines"))
#     treatment_notes: Optional[str] = Field(default=None, validation_alias=AliasChoices("treatment_notes", "plan", "treatment_plan", "notes", "recommendations", "advice", "instructions", "clinical_notes", "history"))
#     precautions: Optional[str] = Field(default=None, validation_alias=AliasChoices("precautions", "warnings", "cautions", "red_flags", "emergency_advice"))
