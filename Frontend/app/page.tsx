...
//         <div className="absolute inset-0 bg-gradient-to-br from-cyan-50 via-white to-emerald-50 opacity-80 pointer-events-none"></div>
//         <div className="absolute top-[-20%] left-1/2 -translate-x-1/2 w-[1400px] h-[1400px] rounded-full bg-emerald-200/40 blur-3xl pointer-events-none"></div>
//         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
//           <div className="grid lg:grid-cols-2 gap-8 items-center">
//             <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-10">
//               <motion.div variants={itemVariants} className="space-y-6">
//                 <div className="inline-flex items-center bg-cyan-100/80 text-cyan-800 px-4 py-2 rounded-full text-sm font-semibold shadow-sm shadow-cyan-500/20">
//                   <Zap className="w-5 h-5 mr-2" />
//                   AI-Powered Connected Care
//                 </div>
//                 <h1 className="sr-only">SwasthyaSetu - your health, intelligently connected</h1>
//                 <ScrollFloat
//                   containerClassName="text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-tight text-slate-900 leading-tight"
//                   textClassName="bg-clip-text text-transparent bg-gradient-to-r from-emerald-500 via-cyan-500 to-blue-500"
//                 >
//                   Healthcare that truly listens
//                 </ScrollFloat>
//                 <p className="text-xl text-slate-600 max-w-xl">
//                   Seamlessly connect with your doctors, discover trusted hospitals, and keep every prescription one tap away. SwasthyaSetu brings India&apos;s care network to your pocket.
//                 </p>
//                 <TextType
//                   as="p"
//                   className="text-lg font-semibold text-emerald-600"
//                   text={[
//                     "AI triage that remembers every prescription.",
//                     "Realtime hospital bed availability across India.",
//                     "Encrypted medical records that travel with you."
//                   ]}
//                   typingSpeed={45}
//                   deletingSpeed={28}
//                   pauseDuration={2400}
//                   cursorClassName="text-cyan-500 ml-1"
//                   textColors={["#047857", "#0ea5e9", "#7c3aed"]}
//                 />
//               </motion.div>
...
//                   <Button
//                     size="lg"
//                     className={`${healthcareGradientClass} text-white text-lg px-8 py-6 w-full sm:w-auto shadow-lg shadow-cyan-500/30 hover:opacity-95 transition-all transform hover:scale-105`}
//                   >
//                     Start Your Journey <ArrowRight className="ml-2 w-5 h-5" />
//                   </Button>
//                 </Link>
//                 <Link href="#how-it-works">
//                   <Button variant="outline" size="lg" className="text-lg px-8 py-6 w-full sm:w-auto border-cyan-200 hover:bg-cyan-50">
//                     Explore the Platform
//                   </Button>
//                 </Link>
//               </motion.div>
//               <motion.div variants={itemVariants} className="flex flex-col sm:flex-row sm:items-center sm:space-x-6 space-y-4 sm:space-y-0 pt-4">
//                 <div className="flex -space-x-4">
//                   <img className="inline-block h-12 w-12 rounded-full ring-2 ring-white" src="https://images.unsplash.com/photo-1491528323818-fdd1faba62cc?auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="Patient Priya smiling" />
//                   <img className="inline-block h-12 w-12 rounded-full ring-2 ring-white" src="https://images.unsplash.com/photo-1550525811-e5869dd03032?auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="Doctor consultation" />
//                   <img className="inline-block h-12 w-12 rounded-full ring-2 ring-white" src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=facearea&facepad=2.25&w=256&h=256&q=80" alt="Patient happy after visit" />
//                 </div>
//                 <div>
...
//                   <p className="text-sm text-slate-600 font-medium">Trusted by 50,000+ patients and 1,000+ clinicians</p>
//                 </div>
//               </motion.div>
//             </motion.div>
...
//                   animate={{ y: 0, opacity: 1 }}
//                   className="mb-4 text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-cyan-500 to-emerald-500"
//                 >
//                   Medical Guru
//                 </motion.h2>
...
//         <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(56,189,248,0.25),_transparent_60%)]"></div>
//         <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
//           <ScrollReveal
//             containerClassName="text-3xl sm:text-4xl lg:text-5xl font-semibold tracking-tight mb-6"
//             textClassName="bg-clip-text text-transparent bg-gradient-to-r from-emerald-300 via-cyan-300 to-sky-400"
//             baseOpacity={0.2}
//             baseRotation={6}
//           >
//             The experience layer for clinics, hospitals, and caregivers
//           </ScrollReveal>
//           <p className="text-lg text-slate-200 max-w-3xl">
//             Orchestrate appointments, tele-health, records, billing, and AI follow-ups from a single delightful workspace.
//             SwasthyaSetu keeps everyone in sync while protecting patient privacy by design.
//           </p>
//           <div className="mt-14">
//             <MagicBento enableStars enableSpotlight enableBorderGlow glowColor="14, 165, 233" />
//           </div>
//         </div>
//       </section>
...
//             <ScrollReveal
//               containerClassName="text-4xl lg:text-5xl font-bold tracking-tighter text-slate-900 mb-4 inline-block"
//               textClassName="bg-clip-text text-transparent bg-gradient-to-r from-cyan-500 via-emerald-500 to-blue-500"
//               baseOpacity={0.2}
//               baseRotation={4}
//             >
...
//                   <CardContent className="p-0 flex flex-col h-full"><div className="flex items-center mb-4">{[...Array(5)].map((_, i) => <Star key={i} className="w-5 h-5 fill-yellow-400 text-yellow-400" />)}</div><blockquote className="text-slate-700 text-lg italic mb-6 flex-grow">&ldquo;{testimonial.quote}&rdquo;</blockquote><div className="flex items-center"><img className="w-14 h-14 rounded-full mr-4" src={testimonial.avatar} alt={testimonial.name} /><div><p className="font-semibold text-slate-900">{testimonial.name}</p><p className="text-cyan-600 font-medium">{testimonial.title}</p></div></div></CardContent>
//                 </Card>
//               </motion.div>
//             ))}
//           </div>
...
//         <div className="absolute inset-0 opacity-20 bg-[radial-gradient(circle_at_top,_rgba(255,255,255,0.45),_transparent_65%)]"></div>
...
import { motion } from "framer-motion";
import {
  Heart, Stethoscope, MapPin, Phone, Calendar, FileText, Users, Zap, Star,
  ArrowRight, Activity, Clock, CheckCircle, Upload, Bell, UserPlus, Search,
  HeartHandshake, Mail, PhoneCall,
  Shield,
  CircleDollarSign
} from "lucide-react";
import { Button } from "@/components/ui/button";
...
const HeroDashboardPreview = () => (
  <div className="relative w-full max-w-md lg:max-w-lg mx-auto">
    <div className="absolute -top-8 -left-8 w-40 h-40 bg-emerald-100/50 rounded-full filter blur-xl opacity-70 animate-blob" />
    <div className="absolute -bottom-8 -right-8 w-40 h-40 bg-cyan-100/50 rounded-full filter blur-xl opacity-70 animate-blob animation-delay-4000" />
    <motion.div
      initial={{ scale: 0.9, opacity: 0 }}
      animate={{ scale: 1, opacity: 1 }}
      transition={{ delay: 0.3, duration: 0.8, type: "spring", stiffness: 100 }}
...
export default function Home() {
  ...
  const floatingNavIconMap: Record<string, ReactNode | undefined> = {
    "how-it-works": <CheckCircle className="h-4 w-4" />,
    features: <Zap className="h-4 w-4" />,
    pricing: <CircleDollarSign className="h-4 w-4" />,
    about: <Star className="h-4 w-4" />,
    contact: <PhoneCall className="h-4 w-4" />
  };

  const floatingNavItems = navItems.map((item) => ({
    name: item.name,
    link: `#${item.id}`,
    icon: floatingNavIconMap[item.id]
  }));
  ...
  const bentoHighlights = [
    {
      ...
      caption: "Role-based dashboards for doctors, reception & pharmacy."
    },
    {
      icon: Shield,
      title: "Govt. grade security",
      caption: "AES-256 at rest, audit trails, consent-led sharing."
    },
    {
      icon: Activity,
      title: "Operational intelligence",
      caption: "Live occupancy, discharge predictions, and revenue pulse."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800">
      ...
      {/* HERO */}
      <section id="hero" className="relative pt-40 pb-28 overflow-hidden isolate">
        {/* backgrounds behind content */}
        <div className="absolute inset-0 -z-10 bg-gradient-to-br from-cyan-50 via-white to-emerald-50 opacity-80 pointer-events-none" />
        <div className="absolute top-[-20%] left-1/2 -translate-x-1/2 w-[1400px] h-[1400px] rounded-full -z-10 bg-emerald-200/40 blur-3xl pointer-events-none" />

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          {/* tighter grid + gap on large screens */}
          <div className="grid lg:grid-cols-[1.05fr_0.95fr] xl:grid-cols-[1.1fr_0.9fr] gap-10 xl:gap-16 items-center">
            {/* LEFT */}
            <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-8 relative z-20">
              <motion.div variants={itemVariants} className="inline-flex items-center bg-cyan-100/80 text-cyan-800 px-4 py-2 rounded-full text-sm font-semibold shadow-sm shadow-cyan-500/20">
                <Zap className="w-5 h-5 mr-2" />
                AI-Powered Connected Care
              </motion.div>
              ...
              {/* headline */}
              <SplitText
                text="Healthcare that truly listens"
                tag="h1"
                splitType="chars"
                className="hero-headline text-left font-extrabold leading-[0.95] text-[clamp(2.25rem,6vw,5rem)] relative z-20 select-none"
                textAlign="left"
                threshold={0.25}
                rootMargin="-120px"
                from={{ opacity: 0, y: 50 }}
              ...
              {/* ✅ simple, always-visible subtitle */}
              <motion.h2
                initial={{ y: 12, opacity: 0 }}
                animate={{ y: 0, opacity: 1 }}
                transition={{ duration: 0.5 }}
                className="relative z-20 text-left text-2xl sm:text-3xl font-extrabold tracking-tight
                           bg-clip-text text-transparent bg-gradient-to-r from-cyan-500 to-emerald-500"
              >
                Medical Guru
              </motion.h2>

              <p className="relative z-20 text-xl text-slate-800 max-w-xl">
                Seamlessly connect with your doctors, discover trusted hospitals, and keep every prescription one tap away.
                SwasthyaSetu brings India&apos;s care network to your pocket.
              </p>

              <div className="relative z-20 text-base">
                <Link href="#beds" className="inline-flex items-center text-cyan-700 hover:text-emerald-600 font-semibold">
                  Realtime hospital bed availability across India.
                  <span className="ml-2 h-5 inline-block w-px bg-slate-300" />
                </Link>
              </div>

              <TextType
                as="p"
                className="relative z-20 text-lg font-semibold text-emerald-600"
                text={[
                  "AI triage that remembers every prescription.",
                  "Realtime hospital bed availability across India.",
                  "Encrypted medical records that travel with you."
                ...
                pauseDuration={2400}
                cursorClassName="text-cyan-500 ml-1"
                textColors={["#047857", "#0ea5e9", "#111827"]}
              />

              <div className="relative z-20 flex flex-col sm:flex-row gap-4 pt-2">
                <Link href="/auth">
                  <Button
                    size="lg"
                    className={`${healthcareGradientClass} text-white text-lg px-8 py-6 w-full sm:w-auto shadow-lg shadow-cyan-500/30 hover:opacity-95 transition-all transform hover:scale-105`}
              ...
              <div className="relative z-20 flex flex-col sm:flex-row sm:items-center sm:space-x-6 space-y-4 sm:space-y-0 pt-4">
                <div className="flex -space-x-4">
                  <img className="inline-block h-12 w-12 rounded-full ring-2 ring-white" src="https://images.unsplash.com/photo-1491528323818-fdd1faba62cc?auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="Patient Priya smiling" />
                  <img className="inline-block h-12 w-12 rounded-full ring-2 ring-white" src="https://images.unsplash.com/photo-1550525811-e5869dd03032?auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="Doctor consultation" />
                  <img className="inline-block h-12 w-12 rounded-full ring-2 ring-white" src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=facearea&facepad=2.25&w=256&h=256&q=80" alt="Patient happy after visit" />
            ...
            {/* RIGHT — less empty space, nicely aligned */}
            <div className="relative flex items-center justify-center z-10 lg:justify-self-start xl:justify-self-center">
      ...
      {/* MAGIC BENTO — light */}
      <section className="relative py-20 bg-gradient-to-b from-white via-cyan-50/40 to-emerald-50/40 text-slate-900 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <motion.h2
            ...
            className="text-3xl sm:text-4xl lg:text-5xl font-semibold tracking-tight mb-6 bg-clip-text text-transparent bg-gradient-to-r from-emerald-600 via-cyan-600 to-sky-600"
          >
            The experience layer for clinics, hospitals, and caregivers
          </motion.h2>
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-3">
            {bentoHighlights.map((item, idx) => (
              <motion.div
                ...
                viewport={{ once: true, amount: 0.4 }}
              >
                <Card className="h-full border border-cyan-100/60 bg-white/70 backdrop-blur-sm shadow-sm hover:shadow-lg transition-shadow">
                  <CardHeader className="flex flex-row items-start gap-4 pb-2">
                    <div className="rounded-xl bg-cyan-100/80 p-2 text-cyan-600">
                      <item.icon className="h-5 w-5" />
                    </div>
                    <CardTitle className="text-lg font-semibold text-slate-900">{item.title}</CardTitle>
                  </CardHeader>
                  <CardContent className="pt-0 text-sm text-slate-600">{item.caption}</CardContent>
                </Card>
              </motion.div>
            ))}
          </div>
      ...
      {/* --- SECTIONS BELOW MAGIC BENTO (ADDED) --- */}
      
      {/* HOW IT WORKS */}
      <section id="how-it-works" ref={howItWorksRef} className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <ScrollReveal
              containerClassName="text-4xl lg:text-5xl font-bold tracking-tighter text-slate-900 mb-4 inline-block"
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12 relative">
            ...
            {howItWorksSteps.map((step, index) => (
              <motion.div key={index} initial={{ y: 50, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ delay: index * 0.15 }} viewport={{ once: true }} className="text-center relative bg-white px-4">
                <div className="flex items-center justify-center w-20 h-20 mx-auto mb-6 rounded-full bg-slate-50 border-2 border-cyan-200 shadow-lg">
                  <step.icon className="w-10 h-10 text-cyan-600" />
                </div>
                <h3 className="text-xl font-semibold text-slate-800 mb-2">{step.title}</h3>
                <p className="text-slate-600">{step.description}</p>
      ...
      {/* FEATURES */}
      <section id="features" ref={featuresRef} className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <motion.h2 initial={{ y: 20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true }} className="text-4xl lg:text-5xl font-bold tracking-tighter text-slate-900 mb-4">A Complete Healthcare Ecosystem</motion.h2>
            <motion.p initial={{ y: 20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ delay: 0.1 }} viewport={{ once: true }} className="text-lg text-slate-600 max-w-3xl mx-auto">Our integrated platform is designed to provide a seamless experience for patients, doctors, and hospitals alike.</motion.p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <motion.div key={index} initial={{ y: 50, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ delay: index * 0.1 }} viewport={{ once: true }}>
                <Card className="h-full bg-white/70 backdrop-blur-sm border border-slate-200/80 shadow-sm hover:shadow-xl hover:border-cyan-400 transition-all duration-300 transform hover:-translate-y-2">
                  <CardHeader>
                    <div className="w-14 h-14 bg-gradient-to-br from-cyan-100 to-emerald-100 rounded-xl flex items-center justify-center mb-4">
      ...
      {/* TESTIMONIALS */}
      <section id="about" ref={aboutRef} className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <motion.h2 initial={{ y: 20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true }} className="text-4xl lg:text-5xl font-bold tracking-tighter text-slate-900 mb-4">Loved by Patients and Doctors</motion.h2>
            <motion.p initial={{ y: 20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ delay: 0.1 }} viewport={{ once: true }} className="text-lg text-slate-600 max-w-3xl mx-auto">Don&apos;t just take our word for it. Here&apos;s what people are saying about SwasthyaSetu.</motion.p>
              ...
              <motion.div key={index} initial={{ y: 50, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ delay: index * 0.15 }} viewport={{ once: true }}>
                <Card className="h-full bg-white p-8 border border-slate-200/80 shadow-lg shadow-slate-200/50">
                  <CardContent className="p-0 flex flex-col h-full">
                    <div className="flex items-center mb-4">{[...Array(5)].map((_, i) => <Star key={i} className="w-5 h-5 fill-yellow-400 text-yellow-400" />)}</div>
                    <blockquote className="text-slate-700 text-lg italic mb-6 flex-grow">&ldquo;{testimonial.quote}&rdquo;</blockquote>
                    <div className="flex items-center">
                      <img className="w-14 h-14 rounded-full mr-4" src={testimonial.avatar} alt={testimonial.name} />
                      <div>
                        <p className="font-semibold text-slate-900">{testimonial.name}</p>
                        <p className="text-cyan-600 font-medium">{testimonial.title}</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
          ...
          <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-12 bg-slate-50 p-8 md:p-12 rounded-2xl border border-slate-200">
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                <a href="mailto:support@swasthyasetu.com" className="flex items-center space-x-3 text-slate-700 hover:text-cyan-600"><Mail className="w-5 h-5 text-cyan-500" /><span>support@swasthyasetu.com</span></a>
                <a href="tel:+911234567890" className="flex items-center space-x-3 text-slate-700 hover:text-cyan-600"><PhoneCall className="w-5 h-5 text-cyan-500" /><span>+91 12345 67890</span></a>
              </div>
              <p className="text-slate-600">Our team is available 24/7 to assist with any inquiries you may have about our platform.</p>
            </div>
            <form className="space-y-4">
              <div><label htmlFor="name" className="text-sm font-medium text-slate-700 sr-only">Name</label><Input id="name" type="text" placeholder="Your Name" /></div>
              <div><label htmlFor="email" className="text-sm font-medium text-slate-700 sr-only">Email</label><Input id="email" type="email" placeholder="Your Email" /></div>
              <div><label htmlFor="message" className="text-sm font-medium text-slate-700 sr-only">Message</label><Textarea id="message" placeholder="Your Message or Demo Request" rows={5} /></div>
              <Button type="submit" size="lg" className={`w-full text-white ${healthcareGradientClass} hover:opacity-90`}>Send Message</Button>
            </form>
          </div>
        </div>
      </section>
